...
namespace Verynormalmod.Worlds
{
	public class World : ModWorld
	{
		public override void ModifyWorldGenTasks(List<GenPass> tasks, ref float totalWeight) {
			...
			if (ShiniesIndex != -1) {
				...
				tasks.Insert(ShiniesIndex + 1, new PassLegacy("SnuuviteOre", SnuuviteOreGeneration));
            }
		}

		private void SnuuviteOreGeneration(GenerationProgress progress) {
			...
			for (int k = 0; k < (int)((double)(Main.maxTilesX * Main.maxTilesY) * 6E-05); k++) {
				...
				WorldGen.TileRunner(x, y, (double)WorldGen.genRand.Next(3, 6), WorldGen.genRand.Next(2, 6), TileType<SnuuviteOre>(), false, 0f, 0f, false, true);
		...
		public static bool ninjaInvasionUp = false;
        public static bool downedNinjaInvasion = false;

        //Initialize all variables to their default values
        public override void Initialize()
        {
            Main.invasionSize = 0;
            ninjaInvasionUp = false;
            downedNinjaInvasion = false;
        }
        ...
        public override TagCompound Save()
        {
            ...
            if (downedNinjaInvasion) downed.Add("ninjaInvasion");
        ...
        public override void Load(TagCompound tag)
        {
            ...
            downedNinjaInvasion = downed.Contains("ninjaInvasion");
        }
        ...
        public override void PostUpdate()
        {
            if(ninjaInvasionUp)
            {
                if(Main.invasionX == (double)Main.spawnTileX)
                {
                    ...
                    NinjaInvasion.CheckNinjaInvasionProgress();
                }
                //Updates the custom invasion while it heads to spawn point and ends it
                NinjaInvasion.UpdateNinjaInvasion();
            }
        }
    }
}